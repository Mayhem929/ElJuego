...
class GraphWin(tk.Canvas):
    ...
    def drawGrid(self):
        ...
        for i in range(int(-height / 2), int(height / 2), 50):
            ln = Line(Point(-width / 2, i), Point(width / 2, i))
            ln.setOutline('grey')
            if i % 250 == 0:
                ln.setWidth(3)
            else:
        ...
        ln = Line(Point(-width / 2, 0), Point(width / 2, 0))
        ln.setOutline('black')
        ln.setWidth(4)
        ln.draw(self)

        for i in range(int(-width / 2), int(width / 2), 50):
            ln = Line(Point(i, -height / 2), Point(i, height / 2))
            ln.setOutline('grey')
            if i % 250 == 0:
                ln.setWidth(3)
            else:
        ...
        ln = Line(Point(0, -height / 2), Point(0, height / 2))
        ln.setOutline('black')
        ln.setWidth(4)
        ln.draw(self)
    ...
    def defaultCoords(self):
        ...
        self.setCoords(-width / 2, -height / 2, width / 2, height / 2)
